...
>>>>>>> Stashed changes
        ...
        rage_click = RageClickService::Detector.new().analyze_clicks(@user_events)
        AggregateEvent.create!(aggregate_event_params(rage_click))
      end
    ...
    def aggregate_event_params(rage_click)
